...
import com.board.review.persistence.ReviewCommentRepository;
...
public class ReviewCommentServiceImpl implements ReviewCommentService {
	...
	@Override
	public Optional<ReviewBoardComment> getComment(Long comnum) {
		return commentRepo.findById(comnum);
	}
	
	
	@Override
	public void saveComment(ReviewBoardComment board) {
	...
	@Override
	public List<ReviewBoardComment> getComments(int cNum, Long num, Long comrestep) {
	...
	@Override
	public List<ReviewBoardComment> getReplyComments(Long num,Long comrestep) {
	...
	@Override
	public List<ReviewBoardComment> getmembernum(Long comgroupnum) { //해당그룹번호에 해당하는 멤버번호가져오기
