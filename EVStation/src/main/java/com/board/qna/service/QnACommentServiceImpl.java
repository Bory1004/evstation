...
import com.board.qna.persistence.QnACommentRepository;

@Service
public class QnACommentServiceImpl implements QnACommentService {

	@Autowired
	private QnACommentRepository DsCoRepo;
	...
	//일반댓글 불러오기
	@Override
	public List<QnABoardComment> getComments(Long boardnum, Long comrestep) {
		return DsCoRepo.findByBoardnumAndComrestepOrderByComdateAsc(boardnum, comrestep); 
	}
	//대댓글만 불러오기
	@Override
	public List<QnABoardComment> getReplyComments(Long boardnum, Long comrestep) {
	...
	@Override
	public void saveComment(QnABoardComment dsComment) {
	...
	@Override
	public Optional<QnABoardComment> getComment(Long comnum) {
