...
<c:forEach items="${list}" var="alarm">
		...
		<div id="${alarm.alanum}">
			<span style="float: left;"><a  href="#getProfile" onclick="getProfile(${alarm.alafromid})">${alarm.member.name}(${alarm.member.id})</a></span><br> <span
				style="float: left;">님이 <a href="content/2/${alarm.boardnum}">답글</a>을 달았습니다. <img style="cursor:pointer;"src="/img/xbutton.png"
