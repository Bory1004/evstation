...
<body>
	...
	<main>
		<div id="center">
			...
			</form><textarea id="boardconten2" name="boardcontent2"></textarea>
		</div>
	</main>
	...
	<script type="text/javascript">
		...
		$("#savebutton").click(function(){
			...
			oEditors.getById["boardcontent2"].exec("UPDATE_CONTENTS_FIELD", []);
			oEditors.getById["boardcontent"].exec("PASTE_HTML", ['test']);
