...
<body>
	...
	<main>
		<div id="center">
			<h4>공지사항 글쓰기</h4><br>
			<form action="/ay/insertBoard" method="post">
				<table class="table table-borderless border">
					<tr><td><a href="/ay/getFreeBoardList"><small style="color: green">공지사항 ></small></a></td></tr>				
					<tr><td><input class="form-control" id="boardtitle" name="title" placeholder="제목을 입력해 주세요."/></td></tr>
					<tr><td align="center"><textarea id="boardcontent" name="content"></textarea></td></tr>
