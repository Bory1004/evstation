	...
	<div id="center">
		...
		<form method="post">
			<table class="table table-borderless border">
				...
				<tr>
					<td><input class="form-control" id="boardtitle" name="boardtitle" placeholder="제목을 입력해 주세요." /></td>
				</tr>
				<tr>
					<td align="center"><textarea id="boardcontent" name="boardcontent"></textarea></td>
				</tr>
				<tr>
					<td align="center"><input class="btn btn-success" id="savebutton" type="submit" value="등록"></td>
				</tr>
			</table>
		</form>
	</div>
