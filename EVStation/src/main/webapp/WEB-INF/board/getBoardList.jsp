	...
	<table class="table table-bordered table-hover" style="width: 800px; margin-left:auto; margin-right:auto;" >
		...
		<tbody class="text-center">
			<c:forEach items="${blist}" var="board">
				<tr>
					<td style="width: 8%">${board.st_num}</td>
					<td style="width: 30%"><a href="/content/${board.st_num}">${board.st_name}</a></td>
					<td style="width: 50%">${board.st_address1}</td>
					<td style="width: 12%">${board.st_closedday}</td>
				</tr>	
			</c:forEach>
		</tbody>		
</table>
